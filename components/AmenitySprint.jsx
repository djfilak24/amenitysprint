"use client";
import { PROJECTS, TIERS, getFeaturedProjects } from "@/lib/projects";
...
// ── PROJECTS DATA ────────────────────────────────────────────────────────────
const PROJECTS = [
  { id:1, tag:"Amenity Study", name:"241 N 5TH ST.", city:"Minneapolis, MN", duration:"2.5 Weeks", investment:"$12K–$14K", type:"Roof Deck · Social Club · Event Space", deliverables:["Floor Plans","3D Renderings","Design Language","Axonometric View"], imgLabel:"Roof Deck Concept · 241 N 5th St.", size:"L" },
  { id:2, tag:"Building Reposition", name:"9320 EXCELSIOR", city:"Minneapolis, MN", duration:"2.5 Weeks", investment:"$3K–$6K", type:"Campus Analysis · Link Activation", deliverables:["Initial Analysis","Site Plan","Opportunity Diagrams","Link Study"], imgLabel:"Campus Aerial · 9320 Excelsior", size:"S" },
  { id:3, tag:"Building Reposition", name:"55 WEST MONROE", city:"Chicago, IL", duration:"4 Weeks", investment:"$12K–$15K", type:"The Urban Eddy · Ground Floor Lobby", deliverables:["Axonometric Plan","Floor Plan","Explorations","Animation"], imgLabel:"Ground Floor Lobby · 55 West Monroe", size:"L" },
  { id:4, tag:"Building Reposition", name:"TWO22 TOWER", city:"Minneapolis, MN", duration:"2 Weeks", investment:"$5K–$8K", type:"2nd Floor Connection · Tenant Lounge", deliverables:["Renderings","Floor Plans","Storytelling Mockup","Animation"], imgLabel:"Tenant Lounge · Two22 Tower", size:"M" },
  { id:5, tag:"Building Reposition", name:"50 SOUTH SIXTH", city:"Minneapolis, MN", duration:"6 Weeks", investment:"$2K–$4K", type:"Atrium Redesign · 5-Step Reposition", deliverables:["Renderings","Material Palette","Floor Plans","360 Tour"], imgLabel:"Atrium Proposal · 50 South Sixth", size:"S" },
  { id:6, tag:"Building Reposition", name:"GOLDEN HILLS", city:"Minneapolis, MN", duration:"3 Weeks", investment:"$2K–$4K", type:"Concept Design · Finish Palette", deliverables:["Concept Plan","Finish Palette","Sketches","360 Tour"], imgLabel:"Concept Renderings · Golden Hills", size:"S" },
  { id:7, tag:"Building Reposition", name:"CBRE CONCOURSE", city:"Atlanta, GA", duration:"2.5 Weeks", investment:"$5K–$8K", type:"Lobby Activation · Modular Trellis System", deliverables:["Construction Docs","Floor Plan","Demolition Plan","Renderings"], imgLabel:"Lobby Activation · CBRE Concourse", size:"M" },
  { id:8, tag:"Building Reposition", name:"1500 SPRING GARDEN", city:"Philadelphia, PA", duration:"3 Weeks", investment:"$8K–$10K", type:"Rooftop Activation · Garden Courtyard", deliverables:["Rooftop Plan","Exterior Study","Entry Sequence","Analysis"], imgLabel:"Rooftop Activation · 1500 Spring Garden", size:"M" },
  { id:9, tag:"Single-to-Multi Tenant", name:"CREST RIDGE", city:"Minnetonka, MN", duration:"6 Months", investment:"$3K–$6K", type:"Agile Planning · Tenant Strategy", deliverables:["Stacking Plans","Agile Timeline","Comp Analysis","Dashboard"], imgLabel:"Leasing Strategy · Crest Ridge", size:"S" },
  { id:10, tag:"Campus & Master Plan", name:"ZNA HQ BUILDING", city:"Chicago, IL", duration:"6 Weeks", investment:"$12K–$14K", type:"The Sculpture in the Park · Campus Reposition", deliverables:["Base Scheme","Alternate Plans","Signage Study","Conference Center"], imgLabel:"Campus Study · ZNA HQ", size:"L" },
];
