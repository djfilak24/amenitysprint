...
export const PROJECTS = {
  "55-west-monroe": {
    ...
    concept: {
      narrative: "The building had the bones — a dramatic 40-story lobby, direct CTA access, and an underutilized ground floor plate. What it lacked was a story. Our sprint reframed the entire asset around a single organizing idea: the Urban Eddy. A place where the city's current slows, circulates, and draws people in rather than flowing past. Four weeks. Full design intelligence.",
      deliverables: [
        { icon: "◎", label: "Site Analysis", desc: "Competitive audit of amenity mix across 12 comparable Loop buildings. Leasing driver mapping." },
        { icon: "◈", label: "Amenity Matrix", desc: "Cost vs. value mapping across 24 potential interventions. 6 selected for concept development." },
        { icon: "◇", label: "Rapid Iterations", desc: "Three design directions tested before ownership alignment on the Urban Eddy concept." },
        { icon: "▣", label: "Design Language", desc: "Materials, palette, lighting strategy, and spatial narrative — the brand behind the building." },
        { icon: "⊞", label: "Floor Plans", desc: "Annotated programming layouts for lobby, connector, and Level 2 terrace activation." },
        { icon: "◆", label: "3D Renderings", desc: "4 photorealistic perspectives for ownership brief, leasing activation, and broker packages." },
      ],
      conceptPhotos: [
        { label: "Competitive Analysis — Loop Amenity Map", aspect: "16/9" },
        { label: "Sketch Studies — Lobby Concept A", aspect: "4/3" },
        { label: "Sketch Studies — Lobby Concept B", aspect: "4/3" },
        { label: "Urban Eddy — Mood Board", aspect: "4/3" },
        { label: "Design Language Board", aspect: "4/3" },
        { label: "Amenity Matrix — Final Selection", aspect: "16/9" },
      ],
    },
    journey: [
      { phase: "Sprint",  color: "#00BADC", week: "Week 1",    label: "Site Visit + Competitive Audit",    desc: "Walked the building with PM and leasing team. Mapped 12 competitive assets within 3 blocks of the Loop." },
      { phase: "Sprint",  color: "#00BADC", week: "Week 2",    label: "Programming + Matrix Workshop",     desc: "Amenity Matrix workshop with ownership. Aligned on 6 high-value interventions. Budget scoped per tier." },
      { phase: "Sprint",  color: "#00BADC", week: "Week 3",    label: "Concept Design — 3 Directions",    desc: "Urban Eddy, The Exchange, and Vertical Village developed in parallel. Urban Eddy selected unanimously." },
      { phase: "Sprint",  color: "#00BADC", week: "Week 4",    label: "Delivery Package + Broker Kit",    desc: "Floor plans, renderings, narrative deck, and full broker activation kit delivered to ownership." },
      { phase: "Design",  color: "#18988B", week: "Month 2–3", label: "Design Development + CDs",         desc: "Full construction documents. Material specifications. Contractor bid package issued. MEP coordination." },
      { phase: "Build",   color: "#FF7F40", week: "Month 4–7", label: "Phased Construction",              desc: "Construction sequenced to maintain 95% tenant operations. Lobby, connector, and terrace delivered on schedule." },
      { phase: "Outcome", color: "#FFD53D", week: "Month 8+",  label: "Leasing Activation + Results",    desc: "Broker launch event held in completed lobby. 14 tours in first 30 days. First lease signed at +18% premium." },
    ],
    gallery: [
      { label: "Lobby — Entry Sequence",         size: "hero",   aspect: "21/9" },
      { label: "The Urban Eddy — Social Hub",    size: "large",  aspect: "3/2"  },
      { label: "Connector — Street to Interior", size: "small",  aspect: "3/4"  },
      { label: "Level 2 — Terrace Activation",   size: "small",  aspect: "3/4"  },
      { label: "Tenant Lounge — Seating Detail", size: "medium", aspect: "4/3"  },
      { label: "Reception — Material Wall",      size: "medium", aspect: "4/3"  },
      { label: "Conference Center",              size: "small",  aspect: "4/3"  },
      { label: "Wayfinding + Signage System",    size: "small",  aspect: "4/3"  },
      { label: "Lobby — Evening Atmosphere",     size: "large",  aspect: "3/2"  },
      { label: "Rooftop — Night Panorama",       size: "hero",   aspect: "21/9" },
    ],
    testimonials: [
  ...
  "241-n-5th": {
    slug: "241-n-5th", name: "241 N 5TH ST.", tagline: "The Social Summit",
    location: "Minneapolis, MN", tag: "Amenity Study", size: "L",
    sprintDuration: "2.5 Weeks", investment: "$12K–$14K",
    sqft: "420,000", floors: 22, class: "Class A", year: "2023",
    unlockHeadline: "A rooftop that became the building's most leasable amenity.",
    unlockSub: "Full concept phase deliverables below. Built project photography and outcome data coming soon.",
    stats: [
      ...
      { value: 14, suffix: "%", label: "Rent Premium", context: "on new leases citing amenity value" },
      { value: 8,  suffix: " mo", label: "Sprint to Completion", context: "concept to construction" },
    ],
    concept: {
      narrative: "The rooftop floor had sat underutilized for three years. The sprint reframed it as the building's social summit — programming three distinct activation zones across a single floor plate to serve morning coffee culture, midday meetings, and after-hours events.",
      deliverables: [],
      conceptPhotos: [
        { label: "Rooftop Programming Diagram", aspect: "16/9" },
        { label: "Concept Sketches — Zone A", aspect: "4/3" },
        { label: "Concept Sketches — Zone B", aspect: "4/3" },
        { label: "Design Language Board", aspect: "4/3" },
        { label: "Floor Plan — Rooftop Level", aspect: "4/3" },
        { label: "3D Rendering — Social Summit", aspect: "16/9" },
      ],
    },
    journey: [],
    gallery: [
      { label: "Rooftop — Social Zone A",   size: "hero",   aspect: "21/9" },
      { label: "Event Space — Full Setup",  size: "large",  aspect: "3/2"  },
      { label: "Terrace Detail",            size: "small",  aspect: "3/4"  },
      { label: "Interior — Bar Area",       size: "small",  aspect: "3/4"  },
      { label: "Pre-Function Space",        size: "medium", aspect: "4/3"  },
      { label: "Night View — Minneapolis",  size: "medium", aspect: "4/3"  },
    ],
    testimonials: [],
  ...
  "two22-tower": {
    slug: "two22-tower", name: "TWO22 TOWER", tagline: "The Connected Floor",
    location: "Minneapolis, MN", tag: "Building Reposition", size: "M",
    sprintDuration: "2 Weeks", investment: "$5K–$8K",
    sqft: "340,000", floors: 28, class: "Class B+", year: "2022",
    ...
    concept: {
      narrative: "The second floor connection was invisible to tenants and leasing teams. The sprint surfaced it as a strategic differentiator — making the connector the building's social spine.",
      deliverables: [],
      conceptPhotos: [
        { label: "Connection Analysis Diagram", aspect: "16/9" },
        { label: "Concept Sketch — Connector A", aspect: "4/3" },
        { label: "Concept Sketch — Lounge", aspect: "4/3" },
        { label: "Material Palette", aspect: "4/3" },
        { label: "Programming Plan", aspect: "4/3" },
        { label: "Rendering — Tenant Lounge", aspect: "16/9" },
      ],
    },
    journey: [],
    gallery: [
      { label: "2nd Floor Connector — Full",  size: "hero",   aspect: "21/9" },
      { label: "Tenant Lounge — Seating",     size: "large",  aspect: "3/2"  },
      { label: "Connection Bridge",           size: "small",  aspect: "3/4"  },
      { label: "Collaboration Nooks",         size: "small",  aspect: "3/4"  },
      { label: "Phone Booth Pods",            size: "medium", aspect: "4/3"  },
      { label: "Materiality Detail",          size: "medium", aspect: "4/3"  },
    ],
    testimonials: [],
  ...
  "cbre-concourse": {
    slug: "cbre-concourse", name: "CBRE CONCOURSE", tagline: "The Living Threshold",
    location: "Atlanta, GA", tag: "Building Reposition", size: "M",
    sprintDuration: "2.5 Weeks", investment: "$5K–$8K",
    sqft: "510,000", floors: 19, class: "Class A", year: "2023",
    unlockHeadline: "A Midtown lobby activation that turned an asset into a talent destination.",
    unlockSub: "Full concept phase deliverables below. Built project photography and outcome data coming soon.",
    stats: [
      { value: 19, suffix: "%", label: "Vacancy Reduction", context: "post-lobby activation" },
      { value: 3,  suffix: "×", label: "Tenant Events Hosted", context: "in first quarter post-completion" },
    ...
    concept: {
      narrative: "The lobby felt dated and transactional. The Living Threshold concept introduced a modular trellis system and biophilic programming layer that redefined the building's first impression and activated dead zones between the garage and tenant floors.",
      deliverables: [],
      conceptPhotos: [
        { label: "Lobby Flow Analysis", aspect: "16/9" },
        { label: "Trellis System — Study", aspect: "4/3" },
        { label: "Biophilic Programming", aspect: "4/3" },
        { label: "Material Board", aspect: "4/3" },
        { label: "Entry Sequence Plan", aspect: "4/3" },
        { label: "Rendering — Living Threshold", aspect: "16/9" },
      ],
    },
    journey: [],
    gallery: [
      { label: "Lobby — Living Threshold",  size: "hero",   aspect: "21/9" },
      { label: "Trellis System — Full View",size: "large",  aspect: "3/2"  },
      { label: "Biophilic Detail",          size: "small",  aspect: "3/4"  },
      { label: "Entry Sequence",            size: "small",  aspect: "3/4"  },
      { label: "Seating Area — Activated",  size: "medium", aspect: "4/3"  },
      { label: "Evening Lobby",             size: "medium", aspect: "4/3"  },
    ],
    testimonials: [],
  ...
  return (
    <div style={{ fontFamily: "'Poppins',sans-serif", background: "#f4f3f0", overflowX: "hidden" }}>
      ...
      <section style={{ background:"#fff", padding:mobile?"4rem 5vw":"7rem 6vw" }}>
        <div ref={conceptRef} style={{ maxWidth:1100, margin:"0 auto" }}>
          <div style={{ display:"grid", gridTemplateColumns:mobile?"1fr":"5fr 7fr",
            gap:mobile?"1.5rem":"5rem", marginBottom:mobile?"2.5rem":"4rem", alignItems:"start" }}>
            <div>
              <div style={{ ...fd(conceptVis,0), fontFamily:"'Poppins',sans-serif", fontSize:"0.6rem",
                fontWeight:600, letterSpacing:"0.2em", textTransform:"uppercase",
                color:"#00BADC", marginBottom:"0.75rem" }}>Concept Phase</div>
              <h2 style={{ ...fd(conceptVis,0.07), fontFamily:"'Poppins',sans-serif", fontWeight:800,
                fontSize:mobile?"clamp(1.6rem,6vw,2rem)":"clamp(1.8rem,2.8vw,2.4rem)",
                color:"#000", lineHeight:1.15 }}>
                {P.sprintDuration}.<br/>Full design<br/>intelligence.
              </h2>
            </div>
            <p style={{ ...fd(conceptVis,0.12), fontFamily:"'Poppins',sans-serif", fontSize:"0.9rem",
              fontWeight:300, color:"#555", lineHeight:1.85 }}>{P.concept.narrative}</p>
          </div>

          {P.concept.deliverables.length > 0 && (
            <div style={{ ...fd(conceptVis,0.16),
              display:"grid", gridTemplateColumns:mobile?"1fr":"repeat(3,1fr)",
              gap:"1px", background:"#ebebeb", border:"1px solid #ebebeb",
              borderRadius:"2px", overflow:"hidden", marginBottom:"3rem" }}>
              {P.concept.deliverables.map((d,i) => (
                <div key={i} style={{ background:"#fff", padding:"1.5rem 1.75rem" }}>
                  <div style={{ fontFamily:"'Poppins',sans-serif", fontSize:"1.1rem",
                    color:"#00BADC", marginBottom:"0.6rem" }}>{d.icon}</div>
                  <div style={{ fontFamily:"'Poppins',sans-serif", fontSize:"0.8rem",
                    fontWeight:700, color:"#000", marginBottom:"0.35rem" }}>{d.label}</div>
                  <div style={{ fontFamily:"'Poppins',sans-serif", fontSize:"0.74rem",
                    fontWeight:300, color:"#777", lineHeight:1.7 }}>{d.desc}</div>
                </div>
              ))}
            </div>
          )}

          {P.concept.conceptPhotos.length > 0 && (
            <div style={{ ...fd(conceptVis,0.2) }}>
              <div style={{ fontFamily:"'Poppins',sans-serif", fontSize:"0.58rem", fontWeight:600,
                letterSpacing:"0.18em", textTransform:"uppercase", color:"#bbb", marginBottom:"1rem" }}>
                Sprint Deliverables — Concept Phase
              </div>
              <div style={{ display:"grid",
                gridTemplateColumns:mobile?"1fr 1fr":"repeat(3,1fr)", gap:"0.5rem" }}>
                {P.concept.conceptPhotos.map((ph,i) => (
                  <div key={i} style={{
                    gridColumn: ph.aspect==="16/9" ? (mobile?"1 / -1":"span 3") : "auto",
                  }}>
                    <Img label={ph.label} aspect={ph.aspect} hover />
                  </div>
                ))}
              </div>
            </div>
